...
class Organizer:
    ...
    def update_stats(self, folder_name):
        ...
        self.stats[folder_name] = (
            self.stats.get(folder_name, 0) + 1
        )
    ...
    def move_file(self, file, folder_name):
        ...
        try:
            ...
            logger.info(
                f"Moved {file.name} to {folder_name} -> {destination}"
            )
    ...
    def organize(self):
        ...
        for index, file in enumerate(files, start=1):
            ...
            if self.verbose:
                ...
                print(
                    f"[{index}/{total_files}] {file.name} --> {folder_name}"
                )
